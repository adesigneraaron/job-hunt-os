...
never touched — [copy the template](https://docs.google.com/spreadsheets/d/1_ChlUZuTMOmS0gIFczzlLqszrSlIcJtcmpjQfT8VUQA/copy) and run one menu item —
about five minutes, entirely optional. Setup guide:
